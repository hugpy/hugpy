// AUTO-GENERATED browser preview mirror of handoff/Landing.jsx — do not ship.
const { useState, useRef, useEffect, useId } = React;
const Link = ({ to, children, ...p }) => <a href={to} {...p}>{children}</a>;
const hugpyLockup = "../assets/hugpy-symbol-dark.svg";
