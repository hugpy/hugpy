"""Structural import policy for hugpy_ops (generated from partition.toml).
...
ALLOWED = ['hugpy_platform', 'hugpy_control', 'hugpy_storage', 'hugpy_engine', 'hugpy_video', 'hugpy_fleet', 'hugpy_curation']
OPTIONAL = []
