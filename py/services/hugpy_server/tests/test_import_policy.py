"""Structural import policy for hugpy_server (generated from partition.toml).
...
PACKAGE = "hugpy_server"
PACKAGE_ROOT = Path(__file__).resolve().parents[1] / "src" / PACKAGE
ALLOWED = ['hugpy_platform', 'hugpy_control', 'hugpy_storage', 'hugpy_engine', 'hugpy_media', 'hugpy_video', 'hugpy_oracle', 'hugpy_fleet', 'hugpy_curation']
OPTIONAL = ['hugpy_discord', 'hugpy_ops']
