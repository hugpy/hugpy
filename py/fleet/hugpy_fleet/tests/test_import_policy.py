"""Structural import policy for hugpy_fleet (generated from partition.toml).
...
ALLOWED = ['hugpy_platform', 'hugpy_control', 'hugpy_storage', 'hugpy_engine']
OPTIONAL = ['hugpy_media', 'hugpy_video']
