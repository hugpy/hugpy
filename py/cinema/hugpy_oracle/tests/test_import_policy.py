"""Structural import policy for hugpy_oracle (generated from partition.toml).
...
PACKAGE = "hugpy_oracle"
PACKAGE_ROOT = Path(__file__).resolve().parents[1] / "src" / PACKAGE
ALLOWED = ['hugpy_platform', 'hugpy_control', 'hugpy_engine', 'hugpy_media', 'hugpy_video']
OPTIONAL = []
