"""Structural import policy for hugpy (generated from partition.toml).
...
ALLOWED = ['hugpy_platform']
OPTIONAL = ['hugpy_server', 'hugpy_fleet', 'hugpy_discord', 'hugpy_ops', 'hugpy_storage', 'hugpy_engine', 'hugpy_oracle', 'hugpy_curation', 'hugpy_video']
