"""Structural import policy for hugpy_curation (generated from partition.toml).
...
PACKAGE = "hugpy_curation"
PACKAGE_ROOT = Path(__file__).resolve().parents[1] / "src" / PACKAGE
ALLOWED = ['hugpy_platform', 'hugpy_control', 'hugpy_storage', 'hugpy_engine', 'hugpy_oracle']
OPTIONAL = []
