...
gh repo clone hugpy/<name> /tmp/<name>-$(date +%Y%m%d) && gh repo delete hugpy/<name> --yes   # then move the clone to ARCHIVE/HUGPY_OLD on the host
...
#   git init in a clean export of py/ (excluding .venv, build, dist) and react/ (excluding node_modules), push main
